  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="prose max-w-4xl mx-auto">
        ...
        <p>
          Welcome to the Africa Day Festival ("we," "our," or "us"). We are committed to protecting your personal
          information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and
          safeguard your information when you visit our website, use our services, or participate in our events.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">2. Information We Collect</h2>
        <p>We collect personal information that you voluntarily provide to us when you:</p>
        <ul className="list-disc pl-6 mb-4">
          <li>Register for the festival or related events</li>
          <li>Sign up as a volunteer, performer, or exhibitor</li>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Photos or videos in which you may appear during our events</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-8 mb-4">3. How We Use Your Information</h2>
        <p>We use your personal information for the following purposes:</p>
        <ul className="list-disc pl-6 mb-4">
          <li>To facilitate your participation in the Africa Day Festival and related events</li>
          <li>To process transactions and send related information</li>
          <li>To send administrative information, such as updates, security alerts, and support messages</li>
          <li>To respond to your inquiries and provide customer support</li>
          <li>To send promotional communications, such as newsletters, if you have opted in</li>
          <li>To improve our website, services, and events based on your feedback</li>
          <li>To comply with legal obligations</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-8 mb-4">4. Cookies and Tracking Technologies</h2>
        <p>
          We use cookies and similar tracking technologies to collect information about your browsing activities. These
          technologies help us analyze website traffic, personalize content, and improve your experience. You can
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>Service providers who help us operate our website and events</li>
          <li>Event partners and sponsors (only with your explicit consent)</li>
